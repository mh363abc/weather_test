<?php
// http://localhost/wechat/xiaochengxu/weather_test/php/lifestyle.php
// error_reporting(0);
...
// 请求地址：
$url = 'https://free-api.heweather.net/s6/weather/lifestyle?location=' . $location . '&key=' . $key . '';
// $rest = file_get_contents($url);
$rest = curl($url, 0, 0, 1);
// $arr = json_decode($rest, true);print_r($arr);exit;
// var_dump($rest);
echo $rest;
